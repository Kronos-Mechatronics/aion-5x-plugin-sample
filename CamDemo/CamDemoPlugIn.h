// CamDemoPlugIn.h : main header file for the CamDemo plug-in.
//
...
public:
  ...
  // CCamDemoPlugIn destructor. The destructor is called to destroy
  // "thePlugIn" when the plug-in is unloaded. Immediately before the
  // DLL is unloaded, CCamDemoPlugIn::OnUnloadPlugin() is called. Do
  // not do too much here. Be sure to clean up any memory you have allocated
  // with onmalloc(), onrealloc(), oncalloc(), or onstrdup().
  ~CCamDemoPlugIn() = default;
